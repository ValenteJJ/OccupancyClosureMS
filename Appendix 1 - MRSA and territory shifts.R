...
# groundhog.library('marcher', '2023-06-02')
...
capLocs = read.csv(text = getURL("https://raw.githubusercontent.com/ValenteJJ/OccupancyClosureMS/main/capLocs.csv"))
...
estDepDates = read.csv(text = getURL("https://raw.githubusercontent.com/ValenteJJ/OccupancyClosureMS/main/estDepDates.csv"))
